...
public sealed class GarurumonEvolutionCriteria : IEvolutionCriteria
{
    public EvolutionStage EvolutionStage => EvolutionStage.Champion;

    public EvolutionResult EvolutionResult => EvolutionResult.Garurumon;
    ...
    public BonusCriteria BonusCriteria => new(discipline: 90, techniqueCount: 28);
}