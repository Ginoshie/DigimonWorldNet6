...
public sealed class KabuterimonEvolutionCriteria : IEvolutionCriteria
{
    ...
    public EvolutionResult EvolutionResult => EvolutionResult.Kabuterimon;
    ...
    public BonusCriteria BonusCriteria => new(techniqueCount: 35, precursorDigimon: DigimonName.Kuwagamon);
}