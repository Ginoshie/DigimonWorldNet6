...
public sealed class MyotismonEvolutionCriteria : IEvolutionCriteria
{
    ...
    public EvolutionResult DigimonType => EvolutionResult.Myotismon;
    ...
    public BonusCriteria BonusCriteria => new(discipline: 100, techniqueCount: 49, precursorDigimon: EvolutionResult.Devimon);
}