...
public class FoodTopicViewModel : TopicViewModelBase
{
            ...
            ShellmonDigiWikiNarratorText.FoodWiki.WikiText)
    {
        ...
        SpeakHungerConditionScreenCommand = new CommandHandler(() => speakShellmonTextNoDelayAction(ShellmonDigiWikiNarratorText.FoodWiki.HungerScreen, SpeakShellmonTextAction));
        SpeakHungerConditionOverworldCommand = new CommandHandler(() => speakShellmonTextNoDelayAction(ShellmonDigiWikiNarratorText.FoodWiki.HungerOverworld, SpeakShellmonTextAction));
