...
public static class ShellmonDigiWikiNarratorText
{
    ...
    public const string FoodWikiText = "Food gives your Digimon a set amount of energy and increase or decrease in weight.  Some foods also reduce Tiredness, increase Happiness and/or Discipline as well as certain stats.\n" +
                                       "\n" +
    ...
    public const string FoodWikiShellFacts = "Shell Fact One\n" +
    ...
    public const string FoodWikiHungerConditionOverworld = "When hungry, your digimon will have a emotion bubble with a meat icon above its head. As long as this emotion bubble is visible it is hungry.\n" +
                                                           "\n" +
                                                           "It will make a uncomfortable movements and growl.\n" +
                                                           "\n" +
                                                           "Doesn't it make you want to feed it?";

    public const string FoodWikiHungerConditionScreen = "When hungry, your digimon will have a status modifier in the CONDITION section of the Status tab of the Digimon menu.\n" +
                                                        "\n" +
