...
public static class ShellmonDigiWikiNarratorText
{
    ...
    public static class PoopWiki
    {
        public const string WikiText = "Digimon poop on a somewhat regular basis. Be sure to find a potty in time or things get stinky.\n" +
                                       ...
                                       "- Ultimate: 6h\n" +
                                       "\n" +
                                       "Once the need to potty arises you'll have 12 seconds plus 0.6 seconds per discipline to find a potty.\n" +
                                       "So the minimum is 12 seconds and the maximum is 72 seconds.\n" +
                                       "\n" +
        ...
        public const string ShellFacts = "Shell Fact One\n" +
                                         ...
                                         "\n" +
                                         "Shell Fact Two\n" +
                                         "Fill up the virus bar and your Digimon will evolve into Sukamon.\n" +
                                         "\n" +
                                         "Shell Fact Three\n" +
                                         "In the US version of the game the time between poops is doubled when your Digimon poops in a toilet or the world.\n" +
                                         "\n" +
                                         "Shell Fact Four\n" +
